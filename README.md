...
**250,179 open roles** at **6,857 companies**,
**42,969** of them remote. Read from each employer's own careers
...
- [Remote](boards/remote.md) — 42,969 roles
- [Berlin](boards/berlin.md) — 2,869 roles
- [London](boards/london.md) — 7,663 roles
- [Paris](boards/paris.md) — 2,443 roles
- [Amsterdam](boards/amsterdam.md) — 1,559 roles
- [Munich](boards/munich.md) — 1,489 roles
- [Madrid](boards/madrid.md) — 827 roles
- [Barcelona](boards/barcelona.md) — 914 roles
- [Dublin](boards/dublin.md) — 992 roles
- [Lisbon](boards/lisbon.md) — 491 roles
- [Zurich](boards/zurich.md) — 249 roles
- [Stockholm](boards/stockholm.md) — 426 roles
- [New York](boards/new-york.md) — 12,486 roles
- [San Francisco](boards/san-francisco.md) — 12,274 roles
- [Engineering](boards/engineering.md) — 58,217 roles
- [Data & AI](boards/data-ai.md) — 33,810 roles
- [Design](boards/design.md) — 12,128 roles
- [Product](boards/product.md) — 13,107 roles
- [Sales](boards/sales.md) — 21,512 roles
- [Marketing](boards/marketing.md) — 10,240 roles
...
| [`data/companies.csv`](data/companies.csv) | All 6,857 companies with open roles |

The data files carry the most recent slice rather than all 250,179
