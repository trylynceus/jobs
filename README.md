...
**257,018 open roles** at **9,470 companies**,
**43,846** of them remote. Read from each employer's own careers
...
- [Remote](boards/remote.md) — 43,846 roles
- [Berlin](boards/berlin.md) — 3,077 roles
- [London](boards/london.md) — 7,786 roles
- [Paris](boards/paris.md) — 2,326 roles
- [Amsterdam](boards/amsterdam.md) — 1,607 roles
...
- [Lisbon](boards/lisbon.md) — 501 roles
- [Zurich](boards/zurich.md) — 293 roles
- [Stockholm](boards/stockholm.md) — 512 roles
- [New York](boards/new-york.md) — 12,908 roles
- [San Francisco](boards/san-francisco.md) — 12,150 roles
- [Engineering](boards/engineering.md) — 59,905 roles
- [Data & AI](boards/data-ai.md) — 33,898 roles
- [Design](boards/design.md) — 12,579 roles
- [Product](boards/product.md) — 12,813 roles
- [Sales](boards/sales.md) — 22,191 roles
- [Marketing](boards/marketing.md) — 11,388 roles
...
| [`data/companies.csv`](data/companies.csv) | All 9,470 companies with open roles |

The data files carry the most recent slice rather than all 257,018
...
| Veterinary Emergency Group (VEG) | 1,116 |
| EquipmentShare | 974 |
| Databricks | 819 |
| ALO | 767 |
| Pavago | 760 |
