...
**257,183 open roles** at **12,365 companies**,
**40,241** of them remote. Read from each employer's own careers
...
- [Remote](boards/remote.md) — 40,241 roles
- [Berlin](boards/berlin.md) — 3,046 roles
- [London](boards/london.md) — 7,133 roles
...
- [Engineering](boards/engineering.md) — 58,351 roles
- [Data & AI](boards/data-ai.md) — 33,328 roles
- [Design](boards/design.md) — 12,810 roles
- [Product](boards/product.md) — 12,107 roles
- [Sales](boards/sales.md) — 21,972 roles
- [Marketing](boards/marketing.md) — 11,209 roles
...
| [`data/companies.csv`](data/companies.csv) | All 12,365 companies with open roles |

The data files carry the most recent slice rather than all 257,183
