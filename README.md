...
**258,235 open roles** at **9,583 companies**,
**43,949** of them remote. Read from each employer's own careers
...
- [Remote](boards/remote.md) — 43,949 roles
- [Berlin](boards/berlin.md) — 3,102 roles
- [London](boards/london.md) — 7,820 roles
- [Paris](boards/paris.md) — 2,333 roles
- [Amsterdam](boards/amsterdam.md) — 1,633 roles
- [Munich](boards/munich.md) — 1,616 roles
- [Madrid](boards/madrid.md) — 843 roles
- [Barcelona](boards/barcelona.md) — 890 roles
- [Dublin](boards/dublin.md) — 990 roles
- [Lisbon](boards/lisbon.md) — 506 roles
- [Zurich](boards/zurich.md) — 297 roles
- [Stockholm](boards/stockholm.md) — 509 roles
- [New York](boards/new-york.md) — 12,962 roles
- [San Francisco](boards/san-francisco.md) — 12,264 roles
- [Engineering](boards/engineering.md) — 60,329 roles
- [Data & AI](boards/data-ai.md) — 34,037 roles
- [Design](boards/design.md) — 12,608 roles
- [Product](boards/product.md) — 12,867 roles
- [Sales](boards/sales.md) — 22,311 roles
- [Marketing](boards/marketing.md) — 11,447 roles
...
| [`data/companies.csv`](data/companies.csv) | All 9,583 companies with open roles |

The data files carry the most recent slice rather than all 258,235
...
| Company | Open roles |
| --- | --- |
| BAYADA Home Health Care | 2,589 |
| Anduril Industries | 2,219 |
| SpaceX | 2,183 |
| Bjakcareer | 1,726 |
| Carvana | 1,696 |
| Speechify | 1,291 |
