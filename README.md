...
**254,043 open roles** at **7,118 companies**,
**43,834** of them remote. Read from each employer's own careers
...
- [Remote](boards/remote.md) — 43,834 roles
- [Berlin](boards/berlin.md) — 2,899 roles
- [London](boards/london.md) — 7,760 roles
- [Paris](boards/paris.md) — 2,415 roles
- [Amsterdam](boards/amsterdam.md) — 1,569 roles
- [Munich](boards/munich.md) — 1,509 roles
- [Madrid](boards/madrid.md) — 854 roles
- [Barcelona](boards/barcelona.md) — 914 roles
- [Dublin](boards/dublin.md) — 964 roles
- [Lisbon](boards/lisbon.md) — 499 roles
- [Zurich](boards/zurich.md) — 264 roles
- [Stockholm](boards/stockholm.md) — 457 roles
- [New York](boards/new-york.md) — 12,488 roles
- [San Francisco](boards/san-francisco.md) — 12,431 roles
- [Engineering](boards/engineering.md) — 59,520 roles
- [Data & AI](boards/data-ai.md) — 34,454 roles
- [Design](boards/design.md) — 12,446 roles
- [Product](boards/product.md) — 13,263 roles
- [Sales](boards/sales.md) — 21,704 roles
- [Marketing](boards/marketing.md) — 10,469 roles
...
| [`data/companies.csv`](data/companies.csv) | All 7,118 companies with open roles |

The data files carry the most recent slice rather than all 254,043
